...
module.exports = {
  ...
  BRANCH: "main",
  WARN_COUNT: 3,
  PACKNAME: process.env.PACKNAME || "ʟᴀᴋʏ_Mᴅ",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "𝘔ᴀʟɪᴛʜ ʟᴀ𝘬ꜱʜᴀɴ",
  HEROKU: toBool(process.env.HEROKU) || false,
  BOT_NAME: process.env.BOT_NAME || "ʟᴀᴋʏ_Mᴅ",
  AUTO_READ: toBool(process.env.AUTO_READ) || false,
  AUTO_STATUS_READ: toBool(process.env.AUTO_STATUS_READ) || false,
  PROCESSNAME: process.env.PROCESSNAME || "ʟᴀᴋʏ_Mᴅ\n> 𝘔ᴀʟɪᴛʜ ʟᴀ𝘬ꜱʜᴀɴ",
